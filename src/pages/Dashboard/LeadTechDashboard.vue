                        ...
                        <template #body>
                            <div class="column reverse">
                                ...
                                <div class="text-right">
                                    <Modal>
                                        <template #header>
                                            <h1 class="text-h5">Ajouter un nouveau challenge</h1>
                                        </template>
                                        <template #body>
                                            ...
                                            <div class="text-right">
                                                <q-btn color="green" label="Créer le challenge" class="q-my-md"></q-btn>
                                            </div>
                                        </template>
                                    </Modal>
                                </div>
                ...
                <div class="q-my-md q-mr-xl">
                    <Card class="my-card bg-black text-white shadow-4 q-pa-md">
                        <template #body>
                            <div class="column reverse">
                                <div class="column items-center">
                                    <h5 class="text-white">Demandes de parcours</h5>
